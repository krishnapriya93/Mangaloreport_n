...
<div class="container-fluid dashboard_bg  min-vh-100">
    ...
    <div class="row pt-3 pb-2" id="bread-row">
        <div class="col-12">
            <span class="h4"> <i class="fas fa-folder-open"></i> &nbsp; Upload Press relation Items</span>
        </div> <!-- ./col12 -->
    ...
    <div class="row py-2" id="warning-row">
        <div class="col-12">
            <div class="alert alert-success" role="alert">
                <span class="text-primary">{{'Upload images for Press relation Stills'}}</span>
            </div> <!-- ./alert -->
        </div>
    </div><!-- ./row -->
    <div class="row py-2">
    ...
    <div class="row py-2" id="warning-row">
        ...
        <div class="col-12">
            <div class="alert alert-success" role="alert">
                ...
                <span class="text-primary">{{'Uploaded images for Press relation Stills'}}</span>
            </div> <!-- ./alert -->
        </div>
    </div><!-- ./row -->
    <a class="col-sm-3 btn btn-sm btn-warning btn-flat mt-3 mb-3" title="" href="{{route('publicrelation')}}"><i class="fa fa-reply" aria-hidden="true"></i> Back to list </a><br>
            ...
            <div class="col-lg-3 p-2 d-flex justify-content-center">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="lightbox" href="{{asset('/assets/backend/uploads/publicrelationitems/'.$res->image) }}">
                            <a id="img_show" href="{{ asset('/assets/backend/uploads/publicrelationitems/'.$res->image) }}" class="img-fluid" alt="film poster">{{ $res->image }}</a>
                        </a>
    ...
    <div class="row p-1">
        <div class="col-12 p-2 d-flex justify-content-end" id="search_col1">
            <input type="hidden" id="usertype_id" name="usertype_id" value="{{$usertype_id}}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.delete_pic_btn').on('click', function(e) {
            ...
            var action_url = "/mediaadmin/publicrelitemdel/" + element_id;
    ...
    var usertype = $("#usertype_id").val();
    var actionurl = '/mediaadmin/pressrelitemstoreuppy/' + hidid;
            ...
            swal({
                ...
                .then(willDelete => {
                    if (willDelete) {
                        ...
                        window.location.href = "/mediaadmin/viewpressrelpics/" + hidid;
