        ...
        <div class="col-md-12">
            <div class="card" id="entry_div" @if($errors->any()) style="display: inline;" @lese style="display: none;" @endif>
                ...
                <div class="card-body">
                    ...
                    @endif
                    @if(isset($edit_f))
                    <form id="formid" method="POST" action="{{ route('updatefunctionalunit') }}" enctype="multipart/form-data">
                    @else
                    <form id="formid" method="POST" action="{{ route('storefunctionalunit') }}" enctype="multipart/form-data">
                    @endif
