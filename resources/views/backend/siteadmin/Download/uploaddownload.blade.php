...
<div class="container-fluid dashboard_bg  min-vh-100">
    ...
    <div class="row pt-3 pb-2" id="bread-row">
        <div class="col-12">
            <span class="h4"> <i class="fas fa-folder-open"></i> &nbsp; Upload Download Items</span>
        </div> <!-- ./col12 -->
    ...
    <div class="row py-2" id="warning-row">
        <div class="col-12">
            <div class="alert alert-success" role="alert">
                <span class="text-primary">{{'Upload images for Downloads Stills'}}</span>
            </div> <!-- ./alert -->
        </div>
    </div><!-- ./row -->
    <div class="row py-2">
    ...
    <a class="col-sm-3 btn btn-sm btn-warning btn-flat mt-3 mb-3" title="" href="{{route('sbu.downloads')}}"><i class="fa fa-reply" aria-hidden="true"></i> Back to list </a><br>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.delete_pic_btn').on('click', function(e) {
            ...
            var action_url = "/sbu/downloaditemdel/" + element_id;
            // if (usertype == 4) {
...
$('button').on('click',function(){
    ...
    var actionurl = '/sbu/downloadstoreuppy/' + hidid;
    // if (usertype == 2) {
    ...
    var uppy = new Uppy.Core({
        ...
        .use(Uppy.Dashboard, {
            ...
            note: '.pdf file formats only, 1–5 files, up to 2 MB',
            // height: 470,
...
.then(willDelete => {
  if (willDelete) {
    window.location.href = "/sbu/viewdownloadpics/" + hidid;
  }
});
            // swal({
            //         title: "KSEB",
