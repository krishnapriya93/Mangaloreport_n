                  ...
                  @if(session('success'))
                   ...
                   @if(isset($edit_f))
                    ...
                    @csrf 
                        ...
                        <input type="hidden" id="sbu_type_edit" name="sbu_type_edit" value="{{$keydata->sbu_type ?? ''}}">
                        ...
                        <div class="row mb-3">
                          <div class="card-body text-primary">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sbu_id" id="main_dashboard" value="1"  @if(isset($edit_f)){{ ($keydata->viewer_id <= 1)   ? 'checked' : '' }}  @else checked @endif>
