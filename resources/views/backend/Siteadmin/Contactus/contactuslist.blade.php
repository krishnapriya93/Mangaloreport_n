    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="row"><div class="col-sm-9"></div><div class="col-sm-3 mt-3"><a href="{{route('sbu.createcontactus')}}" id="addlogobtn" class="btn btn-flat btn-point btn-sm btn-success"><i class="fas fa-plus"></i>&nbsp;Add New Record</a></div> </div>
                @endif
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        @elseif(Auth::user()->role_id==5)
                        <a class="btn btn-primary btn-sm-default" href="{{ route('sbu.editcontactus',\Crypt::encryptString($result->id)) }}">Edit</a>
                            <a class="btn btn-danger btn-sm-default" href="{{ route('sbu.deletecontactus',\Crypt::encryptString($result->id)) }}">Delete</a>
                        @endif
                        </td>
                    </tr>   
                     <!-- $i++; -->
