        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   @if(isset($edit_f))
                    <form id="formiid" method="POST" action="{{ route('updateMenulinktype') }}" enctype="multipart/form-data">
                    @else
                    <form id="formiid" method="POST" action="{{ route('storemenulinktype') }}" enctype="multipart/form-data">
                    @endif
                    ...
                    @csrf 
                        ...
                        <div class="row">
                            <div class="col-sm-10 offset-sm-2">
                               ...
                               @endif
                               <a type="submit" class="btn btn-success" href="{{route('menulinktype')}}">Refresh</a>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="main-btn info-btn rounded-full btn-hover btn-sm-default" href="{{ route('statusmenutype',\Crypt::encryptString($result->id)) }}">Active</a>
                            @else
                            <a class="main-btn deactive-btn rounded-full btn-hover btn-sm-default" href="{{ route('statusmenutype',\Crypt::encryptString($result->id)) }}">Deactive</a>
                            @endif
                        </td>
                        <td>
                            <a class="btn btn-primary btn-sm" href="{{ route('editMenulinktype',\Crypt::encryptString($result->id)) }}">Edit</a>
                            <!-- <a class="btn btn-danger btn-sm" href="{{ route('deleteMenulinktype',\Crypt::encryptString($result->id)) }}">Delete</a> -->
                        </td>
                    </tr>   
                    @endforeach    
                    </tbody>    
