                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6 mb-btm" >
                                    <div class="form-group">
                                        ...
                                        <input id="desig_id{{$langs->id}}" type="text" class="form-control @error('desig_id') is-invalid @enderror" name="desig_id[]" value="{{ $keydata->desig_id ?? old('desig_id.'.$i)}}" required autocomplete="desig_id" placeholder="Enter alt {{$langs->name}} here" autofocus >
