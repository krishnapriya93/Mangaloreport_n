            ...
            <div class="col-md-12">
                ...
                <div class="card @if ($errors->any()) display @else display_status @endif" id="entry_div">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        @if (isset($edit_f))
                            <form id="formid" method="POST" action="{{ route('updateBOD') }}"
                                enctype="multipart/form-data">
                            @else
                                <form id="formid" method="POST" action="{{ route('storeBOD') }}"
                                    enctype="multipart/form-data">
                        @endif
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6 mb-btm">
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect2">Designation in
                                                {{ $langs->name }}</label>
                                            <input id="desig_id{{ $langs->id }}" type="text"
                                                class="form-control @error('desig_id') is-invalid @enderror"
                                                name="desig_id[]" value="{{ $keydata->desig_id ?? old('desig_id.' . $i) }}"
                                                required autocomplete="desig_id"
                                                ...
                                                <tr class="table-sm">
                                                    ...
                                                    <td class="tabsm">
                                                        <a class="btn btn-primary btn-sm"
                                                            href="{{ route('editBOD', \Crypt::encryptString($result->id)) }}">Edit</a>
                                                        <a class="btn btn-danger btn-sm"
                                                            href="{{ route('deleteBOD', \Crypt::encryptString($result->id)) }}">Delete</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
