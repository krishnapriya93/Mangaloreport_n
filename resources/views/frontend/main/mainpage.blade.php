            ...
            <div class="row uptopwidget-list clearfix">
                    ...
                    <div class="region region-uptop-first">
                        <nav role="navigation" aria-labelledby="block-topmenu-menu" id="block-topmenu">
                            <h2 class="visually-hidden" id="block-topmenu-menu">Topmenu</h2>
                                <ul class="menu">
                                    <li class="menu-item">
                                        <a href="/index.php/sitemap" title="Sitemap" data-drupal-link-system-path="node/519">Sitemap</a>
                                    </li>
                                    <li class="menu-item">
                                    ...
                                    <li class="menu-item">
                                        <a href="/index.php/contact" target="_blank" title="Feedback" data-drupal-link-system-path="contact">Feedback</a>
                                    </li>
                                </ul><!--END  menu-->
                        </nav><!--END navigation-->
                    </div><!--END region-->
                ...
                <div class="">
                    <div class="region region-uptop-second">
                        <div id="block-langswitchcustom" class="block block-block-content block-block-contentf7b4c070-cad5-4525-a8c5-0aeba0ccc8cf">
                            <div class="content">
                                <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    <div class="text-align-center" style="float:right; width:110px; right:0px;">
                                        <a aria-label="NMPA English website"
                                                    href="https://newmangaloreport.gov.in/"
                                                    style="color:#fff; padding:2px; font-size:11px;"
                                                    title="NMPA English website">English
                                        </a>&nbsp; |&nbsp;
                                         <a aria-label="NMPA Hindi website"
                                                    href="https://newmangaloreport.gov.in/hi"
                                                    style="color:#fff;  padding:2px;font-size:11px;"
                                                    title="NMPA Hindi website">Hindi
                                        </a>
                                ...
                                <div class="content">
                                    ...
                                    <ul id="superfish-main" class="menu sf-menu sf-main sf-horizontal sf-style-none">
                                        <li id="main-menu-link-content3e671f6f-9b8b-4c77-9340-1d8390ae2430" class="active-trail sf-depth-1 sf-no-children"><a href="/index.php/" class="icon-home is-active sf-depth-1" title="Home">.</a></li>
                                                <!--Dynamic mainmenu-->
                                                @foreach($mainsubmenus as  $mainsubmenu)
                                                  @foreach($mainsubmenu->mainmenu_sub as $mainmenu_sub)
                                                  <li id="main-menu-link-content77a94666-a2a3-485e-b50a-eb254895c7e2"
                                                    class="sf-depth-1 menuparent"><a href="/index.php/brief-history"
                                                        class="sf-depth-1 menuparent" title="About">{{$mainmenu_sub->title}}</a>
                                                        
                                                        <ul>
                                                        @foreach($mainsubmenu->sub_menu as $sub_menu)
                                                        ...
                                                        {{-- article --}}   
                                                            <li id="main-menu-link-contenteb868c68-e201-4944-9cba-ad63939306af" class="sf-depth-2 sf-no-children">
                                                                <a href="#" class="sf-depth-2" value="{{$sub_menu->submenusub[0]->id}}">
                                                                    {{$sub_menu->submenusub[0]->title}}
                                                                </a>
                                                            </li>
                                                        @endif 
