<div class="col-md-6">
    <div class="region region-updates-third">
        <h2 class="title"><img src="{{ asset('/assets/frontend/images/marketing.svg') }}"
                alt="">What's New</h2>
        <div class="tender views-element-container block block-views block-views-blockwhatsnew-block-1"
                                        ...
                                        <div class="views-row views-row-1 views-row-even">
                                            <div class="views-field views-field-title">
                                                <h4 class="field-content"><a
                                                        ...
                                                        in
                                                        connection with Hindi Month-2023. </a>
                                                </h4>
                                            </div>
